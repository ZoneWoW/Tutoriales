...
MovieList[4][2] = { };
MovieList[4][2][1] = {
	video = "Interface\\Cinematics\\WOW_Wrathgate_800"
};
MovieList[4][2][2] = {
	video = "Interface\\Cinematics\\WOW_Wrathgate_1024"
};
...
function MovieFrame_PlayMovie(self, index)
	...
	if (self:StartMovie(MovieList[4][index][self.resolution].video, MovieVolumeList[4])) then
		StopGlueMusic();
		StopGlueAmbience();
		return;
	end
